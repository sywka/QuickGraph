...
import com.shlom.solutions.quickgraph.view.ui.AutofitRecyclerView;
import com.shlom.solutions.quickgraph.view.ui.BackEditText;
...
public abstract class BaseDataSetEditFragment extends BaseFragment implements ColorPickerDialogFragment.OnColorChangedListener {
    ...
    private void setupRecyclerView(View rootView) {
        AutofitRecyclerView recyclerView = (AutofitRecyclerView) rootView.findViewById(R.id.recycler_view);
    ...
    private void updateColor() {        // FIXME: 01.12.2016
        if (colorView != null)
